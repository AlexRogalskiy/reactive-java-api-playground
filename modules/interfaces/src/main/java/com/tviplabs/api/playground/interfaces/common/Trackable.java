...
/** Trackable producer/consumer interface declaration. */
public interface Trackable {
  ...
  /**
   * Return defined element capacity, used to drive new subscription request needs. This is the
   * maximum in-flight data allowed to transit to this elements.
   *
   * @return long capacity
   */
